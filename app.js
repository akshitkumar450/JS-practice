...
/////////////////////////////////////////////
// arguments passed as values and reference
...
// flightNum is just a copy of the flight variable
// passenger object is passed as a reference (same address)
...
// const flightNum = flight; //copyied the value (pass by value) 
// const passenger = jonas; //reference type (we are only passing its reference not pass by reference)
...
// NOTE::->>javascript does not have pass by reference (but it looks like it) it has only pass by value